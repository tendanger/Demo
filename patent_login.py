...
if __name__ == '__main__':
    ...
    base64Name = str(pybase64.b64encode(bytes(strName,encoding='utf-8')), 'utf-8')
    base64Pass = str(pybase64.b64encode(bytes(strPass,encoding='utf-8')), 'utf-8')
    timeData = {
        'username': strName
    }
    data = {
    ...
    f = open('/User/kun/Desktop/valcode.png', 'wb')
